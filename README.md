...
A Model Context Protocol (MCP) server for creating Jira issues via HTTP API. This server provides an HTTPS endpoint that accepts MCP protocol requests to create Jira tickets.
